...
export default function Graph() {
    ...
    //const newDataBase3: number[] = [4, 6, 8, 9, 14, 20, 22, 21, 19, 15, 7, 6];
    const newDataBase3: number[] = [4, 6, 8, 9];

    const [dataInsert, setDataInsert] = useState<string>("")

    const [newData3, setNewData3] = useState<number[]>(newDataBase3);
    ...
    const handleDelete = (): void => {
        const delLastNumber = newData3.splice(-1);
        console.log(delLastNumber)
        setNewData3(delLastNumber);
    }
        ...
        <main className='w-full h-screen bg-white'>
            ...
            <div className="absolute top-[500px] xl:top-[700px] flex items-center justify-center w-full">
                ...
                <button type="button" onClick={handleDelete}
                    ...
                    active:bg-sky-500 active:scale-105 px-6 py-1 rounded shadow-boxcustom hover:shadow-none mx-2'
                >
                    Delete
                </button>
